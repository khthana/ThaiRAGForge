...
├── CONTEXT.md
├── docs/adr/
│   ├── 0001-scope-retrieval-and-index-retrieve-split.md
│   └── 0002-resolution-level-relevance.md
└── src/
```
...
> _Contradicts ADR-0002 (Resolution-level relevance) — but worth reopening because…_
