...
Run 2026-08-12 10:17 UTC. 27 pass / 1 warn / 0 fail.
...
| I6 index newer than corpus | WARN | 40 indexes built before the corpus's last edit |
...
| E0 every result attributes to exactly one index | PASS | 0 of 23156 result files cannot be attributed to one built index (12 of 43 combo ids exist under >1 index root, since BuildCombo.id omits the corpus; attributed 7268 by elimination, 850 by no built index, 212 by recorded, 14826 by unique name) |
...
| G1a no RQ4 answer generated from a truncated prompt | PASS | 0 truncated of 1353 answers carrying num_ctx |
