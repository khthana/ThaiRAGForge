...
from rag_lab.loaders.common import make_resolution_id, parse_path, read_text
...
class PlainLoader(BaseLoader):
    ...
    from its corpus path. Page markers are left in the text for the chunker; no
    cleaning or enrichment — this is the raw baseline."""
